...
For each round of the game, you win a points by rolling a dice.
...
dice is a double (eg: both dice show a three), then your score
 will be DOUBLE the number of the points.

 If you lose the round, then you don't get any points.

 If you and the computer tie (eg: you both get a score 11,
...
# Display instructions if user want to see them.
